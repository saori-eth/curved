    ...
    return (
      <li className="w-full">
        <button
          ...
          className={`flex h-full w-full select-none flex-col items-center justify-center p-3 transition md:flex-row md:justify-start md:space-x-1 md:rounded-full md:py-2 ${props.disabled
              ? "text-slate-600"
