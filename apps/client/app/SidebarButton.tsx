    ...
    return (
      <li className="w-full">
        <button
          ...
          className={`flex h-full w-full select-none flex-col items-center justify-center rounded-full p-3 transition md:flex-row md:justify-start md:space-x-1 md:py-2 ${props.disabled
              ? "opacity-30"
