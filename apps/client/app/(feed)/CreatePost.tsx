...
export function CreatePost() {
  ...
  return (
    ...
    >
      <Dialog.Trigger
        onClick={promptFile}
        className="flex select-none items-center justify-center space-x-2 rounded-2xl bg-white p-5 text-black shadow-dark drop-shadow transition hover:bg-slate-200 hover:shadow-lg active:scale-95 active:drop-shadow-lg md:w-full md:px-6 md:py-4"
      >
