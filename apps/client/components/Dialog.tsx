...
export function DialogContent({
  ...
  return (
    <Dialog.Portal>
      ...
      >
        <Dialog.Content
          className={`mx-2 h-fit max-h-[85%] w-full max-w-xl overflow-y-auto rounded-2xl bg-slate-800 p-4 shadow-lg transition md:py-5 ${
        ...
        >
          <div className="grid grid-cols-3 md:px-5 md:pb-4">
            ...
            <div className="flex items-center justify-end">
              <Dialog.Close
                title="Close"
                className={`rounded-full text-slate-500 transition ${
                  disabled
